    ...
    (e = {
        ...
        e.exports = {
          corePath:
            ...
            "development" === process.env.FFMPEG_ENV
              ...
              : "https://unpkg.com/@ffmpeg/core@".concat(
                  o["@ffmpeg/core"].substring(1),
                  "/dist/ffmpeg-core.js"
                ),
        };
      },
                ...
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          i("info", "fetch ".concat(t)), (e.next = 3), fetch(t)
                        );
                      case 3:
                      ...
                      case 5:
                        return (
                          ...
                          i("info", "".concat(t, " blob URL = ").concat(a)),
                          e.abrupt("return", a)
                        );
                      case 11:
                      case "end":
              ...
              return regeneratorRuntime.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        (n = a(r)), (e.next = 6), c(n, "application/javascript")
                      );
                    case 6:
                      return (
                        (o = e.sent),
                          ...
                          (t.src = o),
                            ...
                            t.addEventListener("load", function r() {
                              t.removeEventListener("load", r),
                                i("info", "ffmpeg-core.js script loaded"),
                                e({
                                  createFFmpegCore,
                                  corePath: o,
                                  wasmPath: s,
                    ...
                    case 15:
                      return (
                        i("info", "ffmpeg-core.js script is loaded already"),
                        e.abrupt(
                          "return",
                          Promise.resolve({
                            createFFmpegCore,
      ...
      698: (e, t, r) => {
        var n = r(497),
          o = r(452),
          a = r(663);
        e.exports = { defaultOptions: n, getCreateFFmpegCore: o, fetchFile: a };
      },
      500: (e) => {
        e.exports = {
        ...
        var r = 0,
          n = function (e) {
            var r,
              ...
              i = o[1],
              c = o[2];
            return 60 * parseFloat(a) * 60 + 60 * parseFloat(i) + parseFloat(c);
          };
        e.exports = function (e, t) {
          if ("string" == typeof e)
          ...
          (o =
            ...
            typeof (n = function () {
              return function () {
                ...
                for (var n, o = document.createElement("a"), a = 1; a < e; a++)
                  (o.href = arguments[a]), (n = o.href), (t.href = n);
